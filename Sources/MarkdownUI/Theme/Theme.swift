...
extension Theme {
    /// Adds a sider link text builder
    /// - Parameter builder: sider link text builder
    public func siderLinkText(_ builder: @escaping SiderLinkTextBuilder) -> Theme {
        var theme = self
        theme.siderLinkTextBuilder = builder
        return theme
    }
}
